...
@implementation NSMutableArray (FoundationUtils)

- (void)rs_removeObjectsPassingTest:(BOOL (^)(id, NSUInteger, BOOL *))predicate {
    NSIndexSet *indexesToRemove = [self indexesOfObjectsPassingTest:predicate];
